...
ux = h5read("../data/turbo2.h5","ux", (256,:,:)) # Read slice
uy = h5read("../data/turbo2.h5","uy", (400,:,:)) # Read slice
uz = h5read("../data/turbo2.h5","uz", (400,:,:)) # Read slice
x = h5read("../data/turbo2.h5","x") # Read slice
y = h5read("../data/turbo2.h5","y") # Read slice
z = h5read("../data/turbo2.h5","z") # Read slice
...
uxplot = contour(x, y, ux, fill = true, linewidth = 0, xlabel = "x [m]",
    label = "u_1")
yaxis!(uxplot, "y [m]")
display(uxplot)
savefig(uxplot, "sonicbat2_xy.pdf")
